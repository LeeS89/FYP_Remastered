...
namespace MatthewAssets
{
    ...
    {
        public ParticleSystem _particleSystem; // Asigna el sistema de partículas en el Inspector
        ...
        {
            SetRandomRotation();
            _particleSystem.Play(); // Inicia el sistema de partículas (opcional)
        }
        ...
        void SetRandomRotation()
        {
            ...
            _particleSystem.transform.rotation = Quaternion.Euler(0f, 0f, randomZRotation);
        }
    }
}