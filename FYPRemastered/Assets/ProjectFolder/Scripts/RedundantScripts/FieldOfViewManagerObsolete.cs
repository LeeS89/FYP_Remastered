...
[Obsolete("")]
public class FieldOfViewManagerObsolete
{
    /// <summary>
    ...
    // NEW
    private FieldOfViewParamsObsolete _params;
    ...
    public FieldOfViewManagerObsolete(
        FieldOfViewParamsObsolete fovParams, 
    ...
    public FieldOfViewManagerObsolete(EnemyEventManager eventManager, FieldOfViewParamsObsolete fovParams, AITraceComponent traceComponent = null)
    {
