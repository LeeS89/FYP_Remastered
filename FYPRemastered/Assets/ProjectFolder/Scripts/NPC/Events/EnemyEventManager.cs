...
[Obsolete]
public class EnemyEventManager : EventManagerObsolete
{
  ...
  //  private List<ComponentEvents> _cachedListeners;
   ...
   // public event Action OnRequestChasingState;
    public event Action<AIDestinationTypeObsolete> OnDestinationRequested;
   ...
   /* public void Reload(bool isReloading)
    ...
    public void DestinationRequested(AIDestinationTypeObsolete type) // Obsolete
    {
