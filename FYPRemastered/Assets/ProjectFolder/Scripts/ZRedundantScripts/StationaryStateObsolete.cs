...
[Obsolete("", true)]
public class StationaryStateObsolete : EnemyStateObsolete
{
    ...
    public StationaryStateObsolete(EnemyEventManager eventManager, GameObject owner) : base(eventManager, owner) { }
    ...
    private IEnumerator DelayJobStart()
    {
        ...
        _agentId = StationaryChaseManagerJobObsolete.Instance.RegisterAgent(LineOfSightUtility.GetClosestPointOnNavMesh(_owner.transform.position), bufferMultiplier, this);
    ...
    public override void ExitState()
    {
        ...
        StationaryChaseManagerJobObsolete.Instance.UnregisterAgent(_agentId);
