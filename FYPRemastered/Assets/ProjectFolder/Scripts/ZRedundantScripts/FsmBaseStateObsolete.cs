...
[Obsolete("", true)]
public abstract class FsmBaseStateObsolete<TDeps> : IFsmStateObsolete where TDeps : FsmBaseStateObsolete<TDeps>.FsmBaseStateDeps
{
 //   protected readonly IPathResolver _pathResolver;
   ...
   // protected NavMeshPath _path;
    ...
    public FsmBaseStateObsolete(TDeps deps, SharedFsmStateServices sharedDeps, IFsmStateEventsObsoleteO stateEvents, StateId id)
    {
        _deps = deps;
