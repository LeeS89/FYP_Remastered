...
[Obsolete("", true)]
public class ChasingStateObsolete : EnemyStateObsolete
{
  
    public ChasingStateObsolete(EnemyEventManager eventManager, GameObject owner, float walkSpeed, float sprintSpeed) : base(eventManager, owner)
    {
