...
{
    public FieldOfViewParamsObsolete prms;
   ...
   /* public bool IsTargetDead { get; protected set; }
    ...
    public override void RegisterLocalEvents(EventManagerObsolete eventManager)
    {
       ...
       // _fovhandler = new FieldOfViewHandlerObsolete(_aiTraceComponent, _enemyEventManager, _fovParams, true);
        ...
        _weaponHandler = new AgentWeaponHandlerObsolete(_enemyEventManager, _normalBulletPoolId, gameObject, _bulletSpawnPoint, player, 20);
