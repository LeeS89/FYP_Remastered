...
[Obsolete("",true)]
public sealed class FSMPatrolStateObsolete : FsmBaseStateObsolete<PatrolDeps>
{
  ...
  //  private readonly IPatrolDeps _patrolDeps;
    ...
    public FSMPatrolStateObsolete(PatrolDeps deps, SharedFsmStateServices sharedDeps, IFsmStateEventsObsoleteO stateEvents) 
...
[Obsolete("", true)]
public sealed class FSMPatrolStateNewObsolete : FsmBaseStateNew<IFsmStateService<ITargetContextObsolete>, ITargetContextObsolete>
{
 //   private readonly IPatrolService _waypointService;
    //  private readonly IPatrolDeps _patrolDeps;
