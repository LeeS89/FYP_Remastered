...
[Obsolete("", true)]
public class FsmFlankStateObsolete : FsmBaseStateObsolete<FlankDeps>
{
   ...
   /* public FSMFlankState(IFlankService flankService, IAgentData data, IPathResolver resolver, IFSMStateContext stateContext) 
    ...
    public FsmFlankStateObsolete(FlankDeps deps, SharedFsmStateServices sharedDeps, IFsmStateEventsObsoleteO stateContext) 
