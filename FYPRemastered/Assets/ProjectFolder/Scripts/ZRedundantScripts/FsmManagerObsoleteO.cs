...
[Obsolete("", true)]
public class FsmManagerObsoleteO : IFsmStateEventsObsoleteO, IFsmController
{
  ...
  //  public bool RotatingToTarget { get; private set; } = false;
    ...
    public FsmManagerObsoleteO(FsmManagerServices deps, SharedFsmStateServices sharedDeps, IReadOnlyDictionary<StateId, IFsmStateObsolete> states, IPathNotifications pathNotifies, IAnimationRequestNotifications animNotifies = null/*, Notification fsmNotifications*/)
    {
        _deps = deps;
