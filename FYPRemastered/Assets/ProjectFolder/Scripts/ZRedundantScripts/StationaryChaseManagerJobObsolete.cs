...
[Obsolete("", true)]
public class StationaryChaseManagerJobObsolete : MonoBehaviour
{
    public static StationaryChaseManagerJobObsolete Instance { get; private set; }
    ...
    private Dictionary<int, EnemyStateObsolete> _agentStates = new();
    ...
    public int RegisterAgent(Vector3 position, float bufferMultiplier, EnemyStateObsolete state)
    {
