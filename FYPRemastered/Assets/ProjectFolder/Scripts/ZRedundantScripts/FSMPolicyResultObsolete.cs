...
[Obsolete("", true)]
public readonly struct FSMPolicyResultObsolete
{
   // public readonly bool PathBlocked;
    ...
    public readonly FSMPolicyObsolete CurrentPolicy;
    public readonly uint Version;

    public FSMPolicyResultObsolete(in FSMPolicyObsolete currentPolicy, PolicyHaltReason reason, /*bool pathBlocked, bool pathToPrimaryBlocked, */bool destinationReached)
    {
...
public readonly struct FSMPolicyValidation
{
  ...
  //  public readonly uint Version;
    ...
    public FSMPolicyValidation(/*in FSMPolicyObsolete currentPolicy,*/ PolicyIntentResult pathResult, Vector3 destination, bool destinationReached)
    {
       // CurrentPolicy = currentPolicy;
