...
public static class ResourceRequestExtension
{
    ...
    {
        var pool = ResourceRequestsObsolete.RequestPool(poolId, componentCallback);
    ...
    {
        var masks = ResourceRequestsObsolete.FlankPointTargetAndBlockingMasks(callback);
    ...
    {
        var pathReq = ResourceRequestsObsolete.RequestPath(start, end, path, callback);
    ...
    {
        var points = ResourceRequestsObsolete.RequestFlankPoints(steps, buffer, callback);
    ...
    {
        var waypoints = ResourceRequestsObsolete.RequestWaypoints(callback);
        SceneEventAggregatorObsolete.Instance.ResourceRequested(waypoints);
    }
}
