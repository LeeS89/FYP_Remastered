        ...
        _pool = new ObjectPool<T>(
            ...
            item => 
            {
                ...
                else if (item is Component c)
                {
                   ...
                   // if (c.transform.parent != _poolContainer) c.transform.SetParent(_poolContainer);
                    if(_transformCache.TryGetValue(item, out var tr))
                    {
                        if (tr.parent != _poolContainer) tr.SetParent(_poolContainer);
                    }
