...
public class AgentRangedWeaponObsolete : RangedWeaponBaseObsolete
{
    ...
    public AgentRangedWeaponObsolete(PoolIdSO poolId, Transform bulletSpawnPoint, Transform target, EnemyEventManager eventManager, GameObject gunOwner, int clipCapacity, Action _cb)
    {
