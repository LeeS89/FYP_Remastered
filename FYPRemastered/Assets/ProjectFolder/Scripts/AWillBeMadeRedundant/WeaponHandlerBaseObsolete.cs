...
public class WeaponHandlerBaseObsolete
{
    protected IWeaponObsolete _equippedWeapon;
    protected RangedWeaponBaseObsolete _rangedWeapon;
    ...
    public WeaponHandlerBaseObsolete(GameObject owner, PoolIdSO normalBulletPoolId)
    {
        _owner = owner;
