...
namespace ProjectDawn.Navigation.Hybrid
{
    ...
    {
        public void AddComponents(EntityManager entityManager, Entity entity, float radius);
        public void RemoveComponents(EntityManager entityManager, Entity entity);
    }
    ...
    public class AgentNavMeshAuthoring : MonoBehaviour, INavMeshWallProvider
    {
        ...
        void INavMeshWallProvider.AddComponents(EntityManager entityManager, Entity entity, float radius)
        {
            entityManager.AddComponentData(entity, new NavMeshBoundary { Radius = radius + 1 });
            entityManager.AddBuffer<NavMeshWall>(entity);
        }

        void INavMeshWallProvider.RemoveComponents(EntityManager entityManager, Entity entity)
        {
            entityManager.RemoveComponent<NavMeshBoundary>(entity);
            entityManager.RemoveComponent<NavMeshWall>(entity);
        }
    }
