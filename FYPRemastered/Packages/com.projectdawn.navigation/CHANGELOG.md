...
## [4.4.6] - 2026-06-29
- Fixed colliderInstanceId errors in unity 6.5

## [4.4.5] - 2025-11-13
- Changed Agent to be IEnableableComponent
- Fixed NavigationLayers.Remove
- Fixed in rare cases where navmesh path is short with lots of node on frequent request it turning back
- Fixed astar displacement to use raycast instead of rely on repair jobs
- Added for spatial partitioning QuerySphereTight, QueryCylinderTight and fixed line cast to use actualy cylinder shape
